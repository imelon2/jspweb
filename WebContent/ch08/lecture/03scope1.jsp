...
<jsp:setProperty name="book2" property="title" value="웹"></jsp:setProperty>

<jsp:useBean id="book3" scope="session" class="ch08.Book"></jsp:useBean>
<jsp:setProperty name="book3" property="title" value="JSP"></jsp:setProperty>

<jsp:useBean id="book4" scope="application" class="ch08.Book"></jsp:useBean>
<jsp:setProperty name="book4" property="title" value="CSS"></jsp:setProperty>
<!DOCTYPE html>
<html>
<head>
