			...
			<div class="col-3">
				<form>
					...
					<div class="form-check">
						<input name="fruit" type="checkbox" id="check1" value="berry">
						<label class="form-check-label" for="check1">딸기 </label>
					</div>

					<div class="form-check">
						<input name="fruit" type="checkbox" id="check2" value="apple">
						<label class="form-check-label" for="check2">사과 </label>
					</div>

					<input type="submit" class="btn btn-primary" calue="전송">
				</form>
			</div>
		</div>
	</div>
